...
{
    public struct PcarsTelemetrySample
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = (int)PcarsApiConstraints.NumberOfParticipants)]
        public PcarsParticipant[] mParticipantData;
        ...
        // Wheels / Tyres
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = (int)Tyre.TYRE_MAX)]
